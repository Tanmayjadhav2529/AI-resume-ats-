...
def extract_text_from_pdf(
    ...
    try:
        ...
        if used_fallback:
            ...
            log_info(
                "PDF extraction succeeded using the "
                "PyPDF2 fallback",
        ...
        raise FileParsingError(
            "Failed to extract text from PDF using "
            "both pdfplumber and PyPDF2. "
            "The PDF may be corrupted, "
            "password-protected, or contain only "
            "scanned images. "
...
def extract_text_from_docx(
    ...
    try:
        ...
        raise FileParsingError(
            ...
            "Please try re-saving or converting "
            "to PDF."
        ) from e
...
def extract_text_from_doc(
    ...
    raise FileParsingError(
        ...
        "Please convert your document to .docx "
        "or .pdf and try again. "
        "You can convert using Microsoft Word, "
        "Google Docs, or online tools."
    )
